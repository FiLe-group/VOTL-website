/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 575d3bd3f817729a41003f1603a76cd6)
// Runtime types generated with workerd@1.20260421.1 2026-03-09 
declare namespace Cloudflare {
	interface Env {
		PUBLIC_ENV__BOT_INVITE: string;
		PUBLIC_ENV__DISCORD_INVITE: string;
		API_ENDPOINT: string;
	}
}
