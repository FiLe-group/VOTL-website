import {Link, Text, VStack, List, chakra} from "@chakra-ui/react";
  ...
  return (
    <>
      ...
      <VStack color='white/60' mt={5} gap={2} alignItems='start'>
        ...
        <Text>If you have questions or comments about this notice, you may email us at <u>mrmaderat1&#123;at&#125;gmail&#123;dot&#125;com</u> OR contact us thru Discord platform by messaging <u>&#123;at&#125; fileeditor</u>.</Text>

        <TextHeading id="request">9. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</TextHeading>
        <Text>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please email us at <u>mrmaderat1&#123;at&#125;gmail&#123;dot&#125;com</u>.</Text>
